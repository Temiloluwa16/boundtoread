    ...
    <section className="bg-red-500 flex flex-col item-center justify-center overflow-hidden">
      <div className="flex items-center justify-center w-full pt-20 px-5 pb-10 bg-[url('/images/ass.jpg')] bg-no-repeat bg-center bg-cover">
        <motion.div
          ...
          className="rounded-2xl bg-pink-700 p-2 md:w-5/12"
        >
      ...
      <div className="flex items-center justify-center flex-col gap-3 bg-white py-14 md:py-28 md:gap-8">
        <motion.h1
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.7 }}
          className="font-bold text-4xl w-10/12 tracking-wide md:4/12 lg:w-5/12 md:text-center lg:text-5xl"
        >
        ...
        <motion.p
          ...
          className="text-base w-10/12 md:w-7/12 lg:w-4/12 md:text-center md:text-lg"
        >
